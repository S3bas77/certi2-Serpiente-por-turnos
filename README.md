...
Juego de serpiente desarrollado con Vite, React y TypeScript.

## Instalación

Se necesita Node.js 18 o una versión posterior.
...
Luego abre la URL que muestre Vite (normalmente `http://localhost:5173`). Usa las
